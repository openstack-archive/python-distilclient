...
from distilclient.v2 import usages


class Client(object):
    def __init__(self, username=None, api_key=None, project_id=None,
                 project_name=None, auth_url=None, distil_url=None,
        ...
        # instead of zun_url
        if endpoint_override and not distil_url:
            distil_url = endpoint_override

        if distil_url and input_auth_token:
        ...
        client_kwargs = {}
        if distil_url:
            client_kwargs['endpoint_override'] = distil_url
